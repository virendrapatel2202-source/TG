<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="N.aspx.cs" Inherits="TG.N" %>
            ...
            <div class="container-fluid" id="exitpage">
                ...
                <div class="text-center clearfix footer-textLayer">
                    <div class="sing-up-button d-lg-block">
                        <a href="P.aspx" class="pull-left"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Back</a>
        ...
        $(document).ready(function () {
            ...
            $("#continue").click(function () {
                ...
                if (!validateName()) {
                    ...
                    $('#pvalid').html('Child Name is required');
                    return;
                }

                $("#exitpage").addClass("animated slideOutRight");
                setTimeout(function () {
                    window.location.href = "S.aspx?Name=" + $("input[id*='txtName']").val();
                }, 500);
            });
        });
